...
## Kronkork's Crafts
Kronkork's Crafts is a crafting table for woodlands where stamps can be arranged in different receipes to "craft" a pin which can be used to activate different things like lightshows or many other things.
